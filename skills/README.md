...
- [html-output](html-output/SKILL.md): readable HTML artifacts with local persistence and complete handover context.
- [html-output-original](html-output-original/SKILL.md): the unchanged original, kept for reference. It retains the original skill name; use the current version above for installation.
